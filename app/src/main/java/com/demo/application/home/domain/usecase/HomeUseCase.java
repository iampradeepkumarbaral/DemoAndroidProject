...
public class HomeUseCase {
    ...
    public ArrayList<KYCDocumentDatamodel> makeAdapterDocumentList(DashboardResModel dashboardResModel, Activity activity) {
        ...
        kyc_one.setDocumentName(activity.getString(R.string.id_proof_front_side));
        kyc_one.setDocumentFileName(activity.getString(R.string.no_file_chosen));
        kyc_one.setButtonText(activity.getString(R.string.choose_file));
        ...
        kyc_two.setDocumentName(activity.getString(R.string.id_proof_back_side));
        kyc_two.setDocumentFileName(activity.getString(R.string.no_file_chosen));
        kyc_two.setButtonText(activity.getString(R.string.choose_file));
        if (dashboardResModel != null) {
        ...
        kyc_three.setDocumentName(activity.getString(R.string.school_id_card));
        kyc_three.setDocumentFileName(activity.getString(R.string.no_file_chosen));
        kyc_three.setButtonText(activity.getString(R.string.choose_file));
        if (dashboardResModel != null) {
        ...
        kyc_four.setDocumentName(activity.getString(R.string.upload_profile_pic));
        kyc_four.setDocumentFileName(activity.getString(R.string.no_file_chosen));
        kyc_four.setButtonText(activity.getString(R.string.choose_file));
        if (dashboardResModel != null) {
    ...
    public boolean checkUploadButtonDoc(ArrayList<KYCDocumentDatamodel> list) {
        String noFileChosen = DemoApp.getAppContext().getString(R.string.no_file_chosen);
