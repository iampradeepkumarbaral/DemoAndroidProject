...
import com.demo.application.databinding.QuizItemLayoutBinding;
...
public class QuizItemAdapter extends RecyclerView.Adapter<QuizItemAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(QuizResModel quizResModel, int position) {
            ...
            binding.quizNum.setText(mContext.getString(R.string.quiz) + " " + "0" + quizResModel.getNumber());
            ...
            if (quizResModel.getScorepoints() == 0) {
                ...
                binding.totalNoPoints.setText(mContext.getString(R.string.total_no_of_points) + " -/" + quizResModel.getTotalpoints());
            } else {
                binding.retakeQuiz.setVisibility(View.VISIBLE);
                binding.totalNoPoints.setText(mContext.getString(R.string.total_no_of_points) + quizResModel.getScorepoints() + "/" + quizResModel.getTotalpoints());
            }
