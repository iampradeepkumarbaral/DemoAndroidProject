...
import com.demo.application.databinding.QuizItemLayout2Binding;
...
public class QuizItemNewAdapter extends RecyclerView.Adapter<QuizItemNewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setChapterListAdapter(SubjectResModel model, int position) {
            int progressCount = 0;
            binding.subjectsChapterRecyclerview.setLayoutManager(new LinearLayoutManager(DemoApp.getAppContext()));
