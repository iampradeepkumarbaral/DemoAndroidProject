...
public interface HomeRemoteApi {
    ...
    @FormUrlEncoded
    Single<Response<JsonObject>> checkUserApi(@FieldMap Map<String,String> params);

    @POST(URLConstant.GRADE_UPGRADE)
    @FormUrlEncoded
    Single<Response<JsonObject>> changeGrade(@FieldMap Map<String,String> params);
    ...
    @FormUrlEncoded
    Single<Response<JsonObject>> sendRefferalapi(@FieldMap Map<String,String> params);
