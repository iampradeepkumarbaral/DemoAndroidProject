...
import com.demo.application.databinding.QuizTestLayoutBinding;
...
//    }
    ...
    public void onResume() {
        super.onResume();
        DashBoardActivity.setListingActiveFragment(DashBoardActivity.QUIZ_TEST_FRAGMENT);
...
*/
    ...
    private void openDialog() {
        ...
        customDialogModel.setTitle(getApplicationContext().getResources().getString(R.string.quiz_instruction));
        customDialogModel.setContent(getApplicationContext().getResources().getString(R.string.bullted_list));
