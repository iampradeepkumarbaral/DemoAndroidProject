package com.demo.application.core.util.uiwidget.others;
...
import com.demo.application.core.util.uiwidget.AsteriskPasswordTransformationMethod;
  ...
  private void styleEditTexts(TypedArray styles) {
    ...
    if (length > 0) {
      ...
      for (int i = 0; i < length; i++) {
       ...
       // editText.setHint(DemoApp.getAppContext().getString(R.string.otp_dot));
        editText.setHint(".");
