...
public class LocationUtil {
    ...
    public static boolean isGPSEnabled() {
        LocationManager locationManager = (LocationManager)
                DemoApp.getAppContext().getSystemService(Context.LOCATION_SERVICE);
    ...
    public static String getDefaultCountryCode() {
        ...
        TelephonyManager tm = (TelephonyManager) DemoApp.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getAddressFromLatLng(double latitude, double longitude,
        ...
        if (latitude != -1D && longitude != -1D) {
            ...
            geocoder = new Geocoder(DemoApp.getAppContext(), Locale.getDefault());
            try {
                ...
                if (addresses != null && !addresses.isEmpty()) {
                    ...
                    return DemoApp.getAppContext().getResources().getString(R.string.address_not_found);
                }
    ...
    public static void setLocationData(Location location) {
        ...
        if (location != null) {
            try {
                ...
                DemoAppPref.INSTANCE.setStringPref(AppConstant.LOCATION_DATA, getJsonFromLocationModel(locationModel));
            } catch (Exception e) {
                AppLogger.e("setLocationData", e.getMessage());
            }
        } else {
            DemoAppPref.INSTANCE.setStringPref(AppConstant.LOCATION_DATA, "");
        }
    }
    ...
    public static LocationModel getLocationData() {
        ...
        if (isGPSEnabled()) {
            String strJSONResponse = DemoAppPref.INSTANCE.getPrefStringValueNotNull(AppConstant.LOCATION_DATA);
