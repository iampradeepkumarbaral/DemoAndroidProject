...
public class LocationHandler implements GoogleApiClient.ConnectionCallbacks,
    ...
    public synchronized void setUpGClient() {
        ...
        googleApiClient = new GoogleApiClient.Builder(DemoApp.getAppContext())
    ...
    public void getCurrentLocation() {
        if (googleApiClient != null) {
            if (googleApiClient.isConnected()) {
                ...
                int permissionLocation = ContextCompat.checkSelfPermission(DemoApp.getAppContext(),
                            ...
                            switch (status.getStatusCode()) {
                                case LocationSettingsStatusCodes.SUCCESS:
                                    ...
                                    int permissionLocation = ContextCompat
                                            .checkSelfPermission(DemoApp.getAppContext(),
                                                    Manifest.permission.ACCESS_FINE_LOCATION);
                                    if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
