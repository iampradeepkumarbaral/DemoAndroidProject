package com.demo.application.util.alert_dialog;
...
import com.demo.application.databinding.DialogPaymentTransferBinding;
...
public class CustomPaymentTranferDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(customDialogModel.getContent().contains("Request accepted")){
            ...
            binding.checkIcon.setBackground(DemoApp.getAppContext().getResources().getDrawable(R.drawable.whitecheck));
            ...
            binding.checkIcon.setBackground(DemoApp.getAppContext().getResources().getDrawable(R.drawable.ic_canclepayment));
